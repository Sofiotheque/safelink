...
$('#hartommy-menuNavigasi').menuomesnap();
$('#hartommy-menuNavigasi .widget').addClass('show-menu');
...
$('#hartommy-menuNavigasi li').each(function() {
...
$('.mobile-logo').each(function() {
                ...
                var $t=$(this), $m=$('#hartommy-menuNavigasi-nav').clone(); $m.attr('id', 'mobileNavigasiMenu'); $m.find('.getMega, .mega-widget, .mega-tab').remove(); $m.find('li.tabMegaMenu .complex-tabs').each(function() {
...
// Copy Text Source
function nocopas(){var e=window.getSelection();pagelink=" Source : "+document.location.href,copytext=e+pagelink,newdiv=document.createElement("div"),newdiv.style.position="absolute",newdiv.style.left="-99999px",document.body.appendChild(newdiv),newdiv.innerHTML=copytext,e.selectAllChildren(newdiv),window.setTimeout(function(){document.body.removeChild(newdiv)},100)}document.addEventListener("copy",nocopas);
